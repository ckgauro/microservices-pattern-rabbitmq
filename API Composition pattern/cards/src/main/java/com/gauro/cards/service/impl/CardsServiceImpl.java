package com.gauro.cards.service.impl;

import com.gauro.cards.constants.CardsConstants;
import com.gauro.cards.dto.CardsDto;
import com.gauro.cards.entity.Cards;
import com.gauro.cards.exception.CardAlreadyExistsException;
import com.gauro.cards.exception.ResourceNotFoundException;
import com.gauro.cards.mapper.CardsMapper;
import com.gauro.cards.repository.CardsRepository;
...
public class CardsServiceImpl implements ICardsService {
    ...
    public void createCard(String mobileNumber) {
        Optional<Cards> optionalCard = cardsRepository.findByMobileNumberAndActiveSw(mobileNumber, CardsConstants.ACTIVE_SW);
